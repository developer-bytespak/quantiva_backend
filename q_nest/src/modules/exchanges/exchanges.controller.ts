...
export class ExchangesController {
  ...
  async getMarketDetail(
    ...
    this.logger.log(`Fetching market detail for ${symbol} on ${exchangeName} (connection: ${connectionId})`);
    ...
    this.logger.debug(`Market detail result for ${symbol}: price=${data.currentPrice}, change24h=${data.change24h}, balance=${data.availableBalance}`);
