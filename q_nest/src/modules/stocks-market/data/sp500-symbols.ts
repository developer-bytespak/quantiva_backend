 ...
 * Complete list of ~503 S&P 500 companies by market cap (as of January 2026)
 * Source: S&P Dow Jones Indices
 * Note: Some companies have multiple share classes (e.g., GOOGL/GOOG, BRK.A/BRK.B)
 */
...
export const SP500_SYMBOLS: StockSymbol[] = [
  ...
  { symbol: 'HPE', name: 'Hewlett Packard Enterprise Co.', sector: 'Technology' },
  ...
  { symbol: 'DG', name: 'Dollar General Corporation', sector: 'Consumer Discretionary' },
  ...
  { symbol: 'CASY', name: "Casey's General Stores Inc.", sector: 'Consumer Discretionary' },
  { symbol: 'LW', name: 'Lamb Weston Holdings Inc.', sector: 'Consumer Discretionary' },
  ...
  { symbol: 'LNC', name: 'Lincoln National Corporation', sector: 'Financials' },
  ...
  { symbol: 'LPLA', name: 'LPL Financial Holdings Inc.', sector: 'Financials' },
  { symbol: 'ZION', name: 'Zions Bancorporation N.A.', sector: 'Financials' },
  { symbol: 'FHN', name: 'First Horizon Corporation', sector: 'Financials' },
  { symbol: 'CMA', name: 'Comerica Incorporated', sector: 'Financials' },
  { symbol: 'WAL', name: 'Western Alliance Bancorporation', sector: 'Financials' },
  { symbol: 'EWBC', name: 'East West Bancorp Inc.', sector: 'Financials' },
  { symbol: 'FCNCA', name: 'First Citizens BancShares Inc.', sector: 'Financials' },
  ...
  { symbol: 'Z', name: 'Zillow Group Inc. Class C', sector: 'Communication Services' },
  ...
  { symbol: 'ACI', name: 'Albertsons Companies Inc.', sector: 'Consumer Staples' },
  { symbol: 'BF.B', name: 'Brown-Forman Corporation Class B', sector: 'Consumer Staples' },
  { symbol: 'SAM', name: 'The Boston Beer Company Inc.', sector: 'Consumer Staples' },
  { symbol: 'KVUE', name: 'Kenvue Inc.', sector: 'Consumer Staples' },
  { symbol: 'CELH', name: 'Celsius Holdings Inc.', sector: 'Consumer Staples' },
  { symbol: 'LNT', name: 'Alliant Energy Corporation', sector: 'Consumer Staples' },
  ...
  { symbol: 'WAB', name: 'Westinghouse Air Brake Technologies Corp.', sector: 'Industrials' },
  ...
  { symbol: 'RRX', name: 'Regal Rexnord Corporation', sector: 'Industrials' },
  ...
  { symbol: 'PR', name: 'Permian Resources Corporation', sector: 'Energy' },
  ...
  { symbol: 'RPM', name: 'RPM International Inc.', sector: 'Materials' },
  ...
  { symbol: 'SLG', name: 'SL Green Realty Corp.', sector: 'Real Estate' },
];
