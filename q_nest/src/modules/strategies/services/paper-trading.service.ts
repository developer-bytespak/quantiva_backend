...
export class PaperTradingService {
  ...
  // Paper trading auto-monitoring is disabled — it ran a heavy DB query every 10 seconds.
  // Signals are still generated by PreBuiltSignalsCronjobService and can be reviewed manually.
