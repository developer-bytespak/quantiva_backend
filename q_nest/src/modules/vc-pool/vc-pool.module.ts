...
import { VcPoolEmailService } from './services/vc-pool-email.service';
...
@Module({
  imports: [PrismaModule, StorageModule, AdminAuthModule, BinanceModule, ExchangesModule, ScheduleModule, NotificationsModule],
  controllers: [
    AdminPoolController,
